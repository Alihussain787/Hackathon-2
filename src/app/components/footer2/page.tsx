...
const footer = () => {
    return(
        <div>
            <footer className="w-full max-w-[1439px] bg-white flex items-center justify-center mt-[80px] max-md:w-full max-md:max-w-3xl max-md:">
                <div className="w-full max-w-[1050px] flex flex-col gap-[80px] max-md:w-full max-md:max-w-3xl ">
                    <div className="w-full max-w-[1050px] bg-white flex items-center justify-center max-md:w-full max-md:max-w-3xl max-md:block">
                        <div className="w-full max-w-[1050px] pb-14 border-b flex justify-between items-center">
                            <h1 className="text-24px text-[#252B42] font-bold">Bandage</h1>
                            <ul className="flex gap-[12px] px-10">
                            <li className="cursor-pointer">
                                <Image className=""src={"/icons/fb.svg"} 
                                alt={"icon"} 
                                width={"16"} 
                                height={"16"}/>
                            </li>
                            <li className="cursor-pointer">
                                <Image className=""src={"icons/ins.svg"} 
                                alt={"icon"} 
                                width={"16"} 
                                height={"16"}/>
                            </li>
                    ...
                    <div className="w-full bg-[#FAFAFA] flex items-center justify-center py-4 max-md:w-full max-md:max-w-3xl max-md:block">
